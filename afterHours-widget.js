(function() {
  ...
  async function fetchClientConfig() {
    try {
      ...
      const response = await fetch(
        `${SUPABASE.url}/rest/v1/widget_clients?client_id=eq.${CLIENT_ID}&select=client_id,status,subscription_status,subscription_plan,is_complimentary,trial_ends_at,booking_url,live_widgets,enabled_widgets,business_name,domain,phone_number,brand_color,position,after_hours_enabled,after_hours_start,after_hours_end,after_hours_timezone,after_hours_message,after_hours_mode,after_hours_allow_call,after_hours_button_color,after_hours_button_text_color,after_hours_popup_icon,after_hours_popup_button_text,after_hours_popup_button_icon,after_hours_use_custom_url,after_hours_custom_url,after_hours_desktop_link_color,after_hours_auto_contrast,after_hours_phone_match_mode,after_hours_target_phone,after_hours_vanity_numbers,after_hours_label,after_hours_booking_text,after_hours_flag_bg,after_hours_flag_text,after_hours_icon,after_hours_flag_position,after_hours_closed_weekends,after_hours_saturday_enabled,after_hours_saturday_start,after_hours_saturday_end,after_hours_sunday_enabled,after_hours_sunday_start,after_hours_sunday_end,show_branding,custom_font_family`,
        {
          headers: {
            'apikey': SUPABASE.key,
            'Authorization': `Bearer ${SUPABASE.key}`
